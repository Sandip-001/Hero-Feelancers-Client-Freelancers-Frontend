...
export default function PaymentHistoryPage() {
  ...
  const [modalView, setModalView] = useState<"withdraw" | "add-method">(
    "withdraw",
  );
  ...
  const getStatusBadge = (status: TransactionStatus) => {
    switch (status) {
      ...
      case "Processing":
        return (
          <Badge className="bg-blue-50 text-blue-600 border-blue-200 shadow-none animate-pulse">
            Processing
          </Badge>
        );
      case "Pending":
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 px-0 py-6 sm:px-6 lg:p-10 space-y-8 font-sans relative pb-24">
      ...
      {toast.show && (
        <div
          className={`fixed top-5 right-5 z-50 flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg border animate-in slide-in-from-top-5 duration-300 ${
            toast.type === "success"
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 px-4 sm:px-0">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Track your project earnings and manage withdrawals.
          </p>
        </div>
        <div className="flex gap-3">
          <Button
            ...
            onClick={() =>
              showToast("Tax Report functionality coming soon!", "success")
            }
          >
        ...
        <Card className="border border-slate-200 shadow-sm bg-white">
          <CardContent className="p-6">
            ...
            <p className="text-xs text-slate-400 mt-2">
              Will be available upon milestone completion
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 px-0 sm:px-0">
                      ...
                      >
                        <td className="p-5">
                          <div className="flex items-center gap-3">
                            <div
                              className={`w-10 h-10 rounded-lg flex items-center justify-center font-bold text-xs ${row.color}`}
                            >
                              {row.logo}
                            </div>
                            <div>
                        ...
                        <td
                          className={`p-5 font-bold ${row.type === "Withdrawal" ? "text-red-600" : "text-green-600"}`}
                        >
                          {row.type === "Withdrawal" ? "-" : "+"} ₹
        ...
        <div className="lg:col-span-4 xl:col-span-3 space-y-6 px-4 sm:px-0">
          <Card className="border-slate-200 shadow-md overflow-hidden rounded-xl">
            <div className="h-24 bg-[#14A9F9] w-full relative"></div>
            ...
            <CardContent className="px-4 pb-6 pt-0">
              ...
              <div className="text-center mb-4">
                ...
                <p className="text-[#14A9F9] font-semibold text-sm">
      ...
      <DevelopmentPopup name={"Payments and Wallet"} /> 
    </div>
  );
}
