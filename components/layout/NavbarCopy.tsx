      ...
      >
        <div className="relative bg-white/90 backdrop-blur-md shadow-md rounded-2xl border border-gray-100 py-4 px-6 md:px-8 flex justify-between items-center z-50">
          ...
          <div className="hidden md:flex gap-6 lg:gap-8 text-sm font-medium text-gray-600 h-full items-center">
                        ...
                        <div key={idx} className="space-y-3">
                          ...
                          <ul className="space-y-2">
                            {section.items.map((item, itemIdx) => (
                              <li key={itemIdx}>
                                <Link
                                  href={`/jobs/${item.toLowerCase().replace(/\s+/g, "-")}`}
                                  className="text-xs text-gray-500 hover:text-blue-500 hover:underline transition-all block"
                                >
                                  {item}
                                </Link>
                              </li>
                      ...
                      <div className="flex flex-col justify-end space-y-3 col-span-2 lg:col-span-1">
                        <div className="bg-blue-50 p-4 rounded-lg">
                          ...
                          <p className="text-xs text-blue-600 mb-3">
                            Get noticed by top clients and win more work.
                          </p>
                          <a
                            href="#"
                            className="text-xs font-bold text-white bg-blue-600 px-4 py-2 rounded-md inline-block hover:bg-blue-700 transition-colors"
                          >
                            Join Now
                          </a>
                        </div>
            ...
            >
              ...
              >
                ...
                <ChevronDown
                  ...
                  className={cn(
                    "transition-transform duration-200",
                    activeDropdown === "freelancers" ? "rotate-180" : "",
                  )}
                />
              </a>
                        ...
                        <div key={idx} className="space-y-3">
                          ...
                          <ul className="space-y-2">
                            {section.items.map((item, itemIdx) => (
                              <li key={itemIdx}>
                                <Link
                                  href={`/freelancers/${item.toLowerCase().replace(/\s+/g, "-")}`}
                                  className="text-xs text-gray-500 hover:text-blue-500 hover:underline transition-all block"
                                >
                                  {item}
                                </Link>
                      ...
                      <div className="flex flex-col justify-end space-y-3 col-span-2 lg:col-span-1">
                        <div className="bg-orange-50 p-4 rounded-lg">
                          ...
                          <p className="text-xs text-orange-600 mb-3">
                            Talk to an expert to find the perfect talent.
                          </p>
                          <a
                            href="#"
                            className="text-xs font-bold text-white bg-orange-500 px-4 py-2 rounded-md inline-block hover:bg-orange-600 transition-colors"
                          >
                            Book Now
                          </a>
                        </div>
            ...
            >
              <Link href="/registration">Post a project</Link>
            </motion.button>
          </div>
          ...
          >
            <div className="p-6">
              ...
              <div className="flex flex-col gap-6">
                  ...
                  >
                    ...
                    <ChevronDown
                      ...
                      className={cn(
                        ...
                        activeMobileCategory === "work" ? "rotate-180" : "",
                      )}
                    />
                  </button>
                  <AnimatePresence>
                ...
                <button className="bg-gradient-to-r from-yellow-500 via-amber-500 to-orange-500 text-white w-full py-3 rounded-xl font-bold shadow-lg shadow-blue-200 mt-4">
                  <Link href="/registration">Post a project</Link>
                </button>
              </div>
            </div>
